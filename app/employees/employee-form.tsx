...
export function EmployeeForm({
  ...
  return (
    <form action={formAction} className="flex w-full max-w-2xl flex-col gap-6">
      ...
      <FormSection title="Identity" description="Legal name and identification, as on file.">
      ...
      <FormSection title="Contact" description="How to reach this employee directly.">
        <div className="flex flex-col gap-1.5">
      ...
      <FormSection title="Emergency contacts" description="Who to notify, primary first.">
        <div className="grid grid-cols-3 gap-3">
          <div className="flex flex-col gap-1.5">
      ...
      <FormSection title="Employment & role" description="Where they sit in the organization.">
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1.5">
      ...
      <FormSection title="Compensation & payroll" description="Entered manually — figures are never auto-calculated.">
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1.5">
      ...
      <FormSection title="Lifecycle" description="Key dates from review to separation.">
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              type="date"
              defaultValue={employee?.next_review_date ?? ""}
            />
          </div>
          <div className="flex flex-col gap-1.5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              type="date"
              defaultValue={employee?.benefits_end_date ?? ""}
            />
          </div>
        </div>
        <div className="flex flex-col gap-1.5">
